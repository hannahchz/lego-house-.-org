...
int main ()
{
    ...
    string inputFilename = "config.txt";
    ...
    while (getline (inputFile, aLine))
    {
        ...
        else if (aLine.find("citylocation.txt") != string::npos) //if citylocation not found, go to end of string
        {
            readFileCity ("citylocation.txt");
            //printSquareCity(xmax, ymax, city);
        }
        else if (aLine.find("cloudcover.txt") != string::npos)
        {
            readFileCloud ("cloudcover.txt");
            //printSquareCloud(xmax, ymax, cloud);
        }
        else if (aLine.find("pressure.txt") != string::npos) // else if
        {
            readFilePressure ("pressure.txt");
    ...
    do
    {
      ...
      switch (usersChoice)
      {
        ...
        case 3 :
            ...
            break;
        case 4 :
            printLMHCloud(xmax, ymax, cloud);
            break;
        case 5 :
            printSquarePressure(xmax, ymax, pressure);
            break;
        case 6 :
            printLMHPressure(xmax, ymax, pressure);
            break;
        case 7 :
            //calculateACC();
            //calculateAP();
        ...
        else
        {
            for (j=-1; j<=cols + 1; j++)
            {
                if (j==-1 || j==cols + 1)    //0 to 8 for y col
                    ...
                    {
                        if ((pressure[k].x == i) && (pressure[k].y == j))
